...
all: main.o capacitive.o pin_utils.o build_dir
	...
	${CC} ${LD_FLAGS} ${BUILD_DIR}'/pin_utils.o' ${BUILD_DIR}'/capacitive.o' ${BUILD_DIR}'/main.o' -O${O_LEVEL} -o ${BUILD_DIR}'/'${OUT_NAME}'.elf'
...
main.o: ${SRC_DIR}/main.cpp build_dir
	@ # Main program
	${CC} -c -std=${CPP_STD} -O${O_LEVEL} ${CC_FLAGS} -I${INCLUDE_DIR}'/' ${SRC_DIR}'/main.cpp' -o ${BUILD_DIR}'/main.o'

capacitive.o: ${SRC_DIR}/capacitive.cpp build_dir	
	${CC} -c -std=${CPP_STD} -O${O_LEVEL} ${CC_FLAGS} -I${INCLUDE_DIR}'/' ${SRC_DIR}'/capacitive.cpp' -o ${BUILD_DIR}'/capacitive.o'

pin_utils.o: ${SRC_DIR}/pin_utils.cpp build_dir	
	${CC} -c -std=${CPP_STD} -O${O_LEVEL} ${CC_FLAGS} -I${INCLUDE_DIR}'/' ${SRC_DIR}'/pin_utils.cpp' -o ${BUILD_DIR}'/pin_utils.o'
