...
typedef uint8_t circular_buffer_sum_t; // It might be changed to uint16_t
...
struct _circular_buffer_t {
    ...
    circular_buffer_sum_t sum; // Sum of all the data in the buffer
};
...
circular_buffer_sum_t circular_buffer_sum(circular_buffer_const_ptr_t buf); // gets the sum of all the data into the buffer
